                ...
                if (!password_verify($password, $row['passwordhash'])) {
                    ...
                    //make a connection to database to insert the bind2hexin
            					...
            					if ($result === FALSE){
            						...
            						//send a 6 character hex code to their email
            						$pageLink = (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
            						$pageLink = str_replace("register.php", "login.php", $pageLink);
            						$to= $email;
            						$subject = "Confirm your email address";
            						$message = "A request has been made to login an account at http://54.236.49.104/it5236/website/index.php for this email address. " .
            						"If you did not make this request, please ignore this message. No other action is necessary. ".
            						"This is your one time password: $hexLogin";
            						$headers = "From: webmaster@alajiacolon.me" . "\r\n" .
            							"Reply-To: webmaster@alajiacolon.me" . "\r\n";
            						mail($to, $subject, $message, $headers);
